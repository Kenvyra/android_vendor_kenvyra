...
ALARM_PATH := vendor/kenvyra/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kenvyra/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kenvyra/prebuilt/common/media/audio/ringtones
