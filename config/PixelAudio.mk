...
ALARM_PATH := vendor/kenvyra/prebuilt/common/media/PixelAudio/alarms
NOTIFICATION_PATH := vendor/kenvyra/prebuilt/common/media/PixelAudio/notifications
RINGTONE_PATH := vendor/kenvyra/prebuilt/common/media/PixelAudio/ringtones
UI_SOUND_PATH := vendor/kenvyra/prebuilt/common/media/PixelAudio/ui
